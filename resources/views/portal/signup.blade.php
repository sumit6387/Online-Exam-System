...
<body>
	...
	<div class="signup_container">
		...
		<hr>
		<form  action="{{url('portal/signup_sub')}}" method="post" class="database_operation">
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="form-group">
						...
						<input type="text" name="no" class="form-control" placeholder="Enter Your Mobile No">
					</div>
				</div>
				<div class="col-sm-12">
					<div class="form-group">
				...
				<div class="col-sm-12">
					<h5 class="btn btn-primary btn-block"><a style="text-decoration: none;color: white;" href="{{url('portal/login')}}">Login</a></h5>
				</div>
			</div>
		</div>
		</form>
