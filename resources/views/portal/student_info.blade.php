...
<aside class="right-side">
                ...
                <section class="content">
                	<div class="container">
                		...
                		<hr>
                		<form action="{{url('portal/update_form_submit')}}" class="database_operation">
                		   <div class="row">
                			<div class="form-group">
                				<div class="col-sm-12 my-2"  style="margin: 10px;">
                					...
                					<input type="text" name="name" value="{{$student_info[0]['name']}}" placeholder="Enter Name" class="form-control">
                				</div>
                			</div>
                			<div class="form-group">
                				<div class="col-sm-12 my-2"  style="margin: 10px;">
                					<label for="Name" >Enter E-Mail</label>
                					<input type="email" name="email" value="{{$student_info[0]['email']}}" required="required" placeholder="Enter E-Mail" class="form-control">
                				</div>
                			</div>
                			<div class="form-group">
                				<div class="col-sm-12 my-2"  style="margin: 10px;">
                					<label for="Name">Enter Mobile-No</label>
                					<input type="text" name="no" value="{{$student_info[0]['mobile_no']}}" required="required" placeholder="Enter Mobile-No" class="form-control">
                				</div>
                			</div>
                			<div class="form-group">
                				<div class="col-sm-12 my-2"  style="margin: 10px;">
                					<label for="Name">Enter DOB</label>
                					<input type="date" name="dob" required="required" value="{{$student_info[0]['dob']}}"  class="form-control">
                				</div>
                			</div>
                			<div class="form-group">
                				<div class="col-sm-12 my-2"  style="margin: 10px;">
