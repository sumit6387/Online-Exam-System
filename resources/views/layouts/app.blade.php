                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="{{url('admin/exam_category')}}">
                                <i class="nav-icon fas fa-th"></i> <span>Category</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url('admin/manage_exam')}}">
                                <i class="nav-icon fas fa-th"></i> <span>Manage Exam</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url('admin/manage_students')}}">
                                <i class="nav-icon fas fa-th"></i> <span>Students</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url('admin/manage_portal')}}">
                                <i class="nav-icon fas fa-th"></i> <span>Portal</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url('admin/logout')}}">
                                <i class="nav-icon fas fa-th"></i> <span>Logout</span>
                            </a>
                        </li>
                       </ul> 
                </section>
