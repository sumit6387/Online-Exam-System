...
Route::group(['middleware'=>['student']],function(){
	...
	Route::post('student/submit_answer','StudentOperation@submit_answer');
	Route::get('student/result/{id}','StudentOperation@result');
});


// Route::get('/home', 'HomeController@index')->name('home');
// Route::get('/admin','Admin@index')->middleware('auth');
// Route::get('/admin/exam_category','Admin@exam_category')->middleware('auth');
